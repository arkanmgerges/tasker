...
use MultiTierArchitecture\Exception\Definition\CriticalAbstract as MultiTierArchCriticalAbstract;
 ...
 * @version  GIT: $Id:$
 */
abstract class CriticalAbstract extends MultiTierArchCriticalAbstract
{
    /**
